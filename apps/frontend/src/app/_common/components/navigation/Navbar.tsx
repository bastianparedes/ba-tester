...
import { ChevronDown, ChevronRight, CircleUser, LogOut, User } from 'lucide-react';
            ...
            <div className="relative">
              ...
              >
                ...
                <div className="text-left">
                  ...
                  <div className="text-xs text-gray-500">{user.data.email}</div>
                </div>
