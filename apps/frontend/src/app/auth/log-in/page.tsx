      ...
      <div className="flex-1 bg-linear-to-br from-blue-600 to-purple-700 p-12 flex flex-col justify-center text-white">
        <div className="max-w-md">
          ...
          <p className="text-lg text-blue-100">
            Ingresa a tu cuenta para acceder a todas las funcionalidades de nuestra plataforma. Gestiona tus proyectos, colabora con tu equipo y lleva tu productividad al
            siguiente nivel.
          </p>
        </div>
      </div>
