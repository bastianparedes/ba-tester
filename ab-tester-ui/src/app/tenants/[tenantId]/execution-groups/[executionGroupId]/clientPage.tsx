...
import type { TypeCampaignForExecutionGroup } from '@digital-retail/ab-tester-types/campaign';
import type { TypeExecutionGroupWithOptionalId } from '@digital-retail/ab-tester-types/executionGroup';
